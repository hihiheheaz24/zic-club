...
(function () {
    ...
    var GROUP_FB_B1 = '#';
    var FANPAGE_FB_B1 = 'https://www.facebook.com/Camp88conggamexanhchin';
    ...
    var TELE_HOTRO = 'https://t.me/camp88_club_cskh';
    var TAI_OTP_X6 = 'http://t.me/camp88funbot';
    var LIVE_CHAT = 'https://t.me/camp88_club_cskh';


    var DOWNLOAD_URL_B1 = 'https://tai.camp88.club/';
    var DOWNLOAD_URL_B2 = 'https://tai.camp88.club/';
    var DOWNLOAD_URL_B3 = 'https://tai.camp88.club/';
    var DOWNLOAD_URL_B4 = 'https://tai.camp88.club/';
    ...
    //FAKE 2
    var GROUP_FB_B1_F = 'https://www.facebook.com/k.o88official';
    var FANPAGE_FB_B1_F = 'https://www.facebook.com/';

    var GROUP_FB_B2_F = 'https://www.facebook.com/k.o88official';
    var FANPAGE_FB_B2_F = 'https://www.facebook.com/k.o88official';

    var GROUP_FB_B3_F = 'https://www.facebook.com/k.o88official';
    var FANPAGE_FB_B3_F = 'https://www.facebook.com/k.o88official';
    ...
    Config = (function () {
        ...
        Config.prototype.getGameName = function (gameId) {
            switch (gameId.toString()) {
				...
				case cc.GameId.TAI_XIU_SIEUTOC:
                    return cc.GameName.TAI_XIU_SIEUTOC;
				...
				case cc.GameId.XOC_DIA_VIP:
                    return cc.GameName.XOC_DIA_VIP;
				case cc.GameId.XOC_DIA_MINI:
                    return cc.GameName.XOC_DIA_MINI;
				case cc.GameId.XOC_DIA_MINI2:
                    return cc.GameName.XOC_DIA_MINI2;
				case cc.GameId.XOC_DIA_MINI3:
                    return cc.GameName.XOC_DIA_MINI3;
				case cc.GameId.XOC_DIA_MINI4:
                    return cc.GameName.XOC_DIA_MINI4;
				...
				case cc.GameId.BAUCUA_MINI:
                    return cc.GameName.BAUCUA_MINI;
                    //game bai chia phong
        ...
        Config.prototype.getSubDomainByHub = function (hubName) {
            switch (hubName) {
				...
				case cc.HubName.XocDiaVipHub:
                    return cc.SubdomainName.XOC_DIA_VIP;
				case cc.HubName.XocDiaMiniHub:
                    return cc.SubdomainName.XOC_DIA_MINI;
				case cc.HubName.XocDiaMini2Hub:
                    return cc.SubdomainName.XOC_DIA_MINI2;
				case cc.HubName.XocDiaMini3Hub:
                    return cc.SubdomainName.XOC_DIA_MINI3;
				case cc.HubName.XocDiaMini4Hub:
                    return cc.SubdomainName.XOC_DIA_MINI4;	
                case cc.HubName.BauCuaHub:
                    return cc.SubdomainName.BAUCUA;
				case cc.HubName.BauCuaMiniHub:
                    return cc.SubdomainName.BAUCUA_MINI;
				...
				case cc.HubName.SieuTocLuckyDiceHub:
                    return cc.SubdomainName.TAI_XIU_SIEUTOC;
        ...
        Config.prototype.mesenGer = function () {
            return FANPAGE_FB_B1;
        };
