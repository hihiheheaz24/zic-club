    ...
    cc.BacaratInfoView = cc.Class({
            ...
            switch (state) {
                case cc.BacaratMapGameState.BETTING:
                    if (this.currentState != state) {
                        ...
                        this.dealerSkeleton.clearTracks();
                        this.dealerSkeleton.setToSetupPose();
                        this.dealerSkeleton.setAnimation(0, 'Idle', false);
                ...
                case cc.BacaratMapGameState.SHOW_RESULT:
                    if (this.currentState != state) {
                        ...
                        cc.AudioController.getInstance().stopSound(cc.AudioTypes.COUNT_DOWN);
                        ...
                        try {
                            if (parseInt(data.Ellapsed) >= 15 && !cc.game.isPaused()) {
                                // this.dealerSkeleton.clearTracks();
                                // this.dealerSkeleton.setToSetupPose();
                                // this.dealerSkeleton.setAnimation(0, 'Discard', false);
                                //Chia bai
                ...
                case cc.BacaratMapGameState.PREPARE_NEW_ROUD:
                    // cc.AudioController.getInstance().enableSound(true);
                    cc.AudioController.getInstance().playSound(cc.AudioTypes.START_BET);
                    if (this.currentState != state) {
                        ...
                        if (!cc.game.isPaused()) {
                            this.dealerSkeleton.clearTracks();
                            this.dealerSkeleton.setToSetupPose();
                            this.dealerSkeleton.setAnimation(0, 'TakeCardAll', false);
                        ...
                        this.updatePlayersUI(window.bacaratVipPlayers);
                ...
                case cc.BacaratMapGameState.END_BETTING:
                    if (this.currentState != state) {
                        ...
                        // cc.AudioController.getInstance().enableSound(true);
                        cc.director.getScheduler().schedule(function () {
                            cc.AudioController.getInstance().playSound(cc.AudioTypes.COUNT_DOWN);
                        }, this, 1, 2, 0, false);
                        cc.AudioController.getInstance().playSound(cc.AudioTypes.STOP_BET);
        ...
        playerShowBubbleChat: function (message) {
            ...
            if (cc.ChatRoomController.getInstance().checkIsEmotion(message)) {
                this.lstPlayers.every(function (player) {
