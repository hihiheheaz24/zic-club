...
(function () {
    cc.BacaratPlayer = cc.Class({
        ...
        onLoad: function () {
            ...
            this.WinEffect_poker = this.node.getChildByName('WinEffect_poker');
        ...
        resetPlayerResultUI: function () {
            ...
            this.WinEffect_poker.active = false;
            this.borderVictoryLine.active = false;
        },
        ...
        playerResultUI: function (amount, balance) {
            ...
            this.WinEffect_poker.active = true;
            this.borderVictoryLine.active = true;
