    ...
    cc.RoomView = cc.Class({
        ...
        onDestroy: function () {
            ...
            if (cc.sys.isNative) {
                switch (this.gameId) {
                    case cc.GameId.EGYPT:
                        cc.assetManager.releaseAsset('egypt/prefabs');
                        cc.assetManager.releaseAsset('egypt/images');   
                        break;
                    case cc.GameId.GAINHAY:
                        cc.assetManager.releaseAsset('gainhay/prefabs');
                        cc.assetManager.releaseAsset('gainhay/images');
                        break;
                    case cc.GameId.THREE_KINGDOM:
                        cc.assetManager.releaseAsset('tk/prefabs');
                        cc.assetManager.releaseAsset('tk/images'); 
                        break;
                    case cc.GameId.AQUARIUM:
                        cc.assetManager.releaseAsset('aquarium/prefabs');
                        cc.assetManager.releaseAsset('aquarium/images'); 
                        break;
                    case cc.GameId.DRAGON_BALL:
                        cc.assetManager.releaseAsset('dragonball/prefabs');
                        cc.assetManager.releaseAsset('dragonball/images'); 
                        break;
                    case cc.GameId.BUM_BUM:
                        cc.assetManager.releaseAsset('bumbum/prefabs');
                        cc.assetManager.releaseAsset('bumbum/images'); 
                        break;
                    case cc.GameId.COWBOY:
                        cc.assetManager.releaseAsset('cowboy/prefabs');
                        cc.assetManager.releaseAsset('cowboy/images');
                        break;
                    case cc.GameId.THUONG_HAI:
                        cc.assetManager.releaseAsset('demthuonghai/prefabs');
                        cc.assetManager.releaseAsset('demthuonghai/images');
                        break;
                }
            }
