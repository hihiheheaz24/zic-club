    ...
    Hub = (function () {
        ...
        Hub.prototype.connect = function (controller, hubName, connectionToken, isReconnect, channelChatId) {
            if (hubName && controller) {
                ...
                try {
                    ...
                    console.log(`connecting hub: ${hubName}`);
                    ...
                    // if (hubName === cc.HubName.DragonTigerHub || hubName === cc.HubName.XocXocHub || hubName === cc.HubName.XocDiaVipHub || hubName === cc.HubName.XocDiaMiniHub 
					// 	|| hubName === cc.HubName.XocDiaMini4Hub || hubName === cc.HubName.XocDiaMini3Hub || hubName === cc.HubName.XocDiaMini2Hub 
					// 	|| hubName === cc.HubName.XocDiaDoiKhangHub|| hubName === cc.HubName.ChatHub ||
                    ...
                    //     hubName === cc.HubName.BauCuaMiniHub || hubName === cc.HubName.LodeHub || hubName === cc.HubName.VietlotHub) {

                    //     if (host === 'ibom2.cc' || host === 'ibom3.cc') {
                    //         host = 'sabagame.co';
                    //     }
                    // }
					console.log(cc.Config.getInstance().getSubDomainByHub(hubName));
        ...
        Hub.prototype.enterLobby = function () {
            ...
            switch (this.hubName) {
				...
				case cc.HubName.XocDiaDoiKhangHub:
        ...
        Hub.prototype.onMessage = function (obj) {
            ...
            //console.log(this.hubName + ' onMessage: ');
