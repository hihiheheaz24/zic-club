...
(function () {
    cc.MethodHubOnName = cc.Enum({
		...
		//taixiuSieuToc
        SESSION_INFO_SIEUTOC: 'SieuTocsessionInfo', //enterLobby
        GAME_HISTORY_SIEUTOC: 'SieuTocgameHistory', //enterLobby
        BET_OF_ACCOUNT_SIEUTOC: 'SieuTocbetOfAccount', //enterLobby
        BET_SUCCESS_SIEUTOC: 'SieuTocbetSuccess', //Bet
        WIN_RESULT_SIEUTOC: 'SieuTocwinResult',
        CORD_ACCOUNT_INFO_SIEUTOC: 'SieuToccordAccountInfo', //thong tin du day của user
        EVENT_WINNER_RESULT_SIEUTOC: 'SieuToceventWinnerResult', //ket qua khi trieu hoi duoc rong -> ban cho tat ca user
        SUMMON_DRAGON_AWARD_SIEUTOC: 'SieuTocsummonDragonAward',
        ...
        BALANCE_UPDATE: 'userUpdateBalance',
