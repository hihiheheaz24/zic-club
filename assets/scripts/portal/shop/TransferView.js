    ...
    cc.TransferView = cc.Class({
        ...
        historyClicked: function () {
            if (cc.LoginController.getInstance().checkLogin()) {
                cc.LobbyController.getInstance().createTransferTransactionView();
                cc.DDNA.getInstance().uiInteraction(cc.DDNAUILocation.PORTAL, 'TRANSFER_HISTORY', cc.DDNAUIType.BUTTON);
                //this.closeSetting();
            }
        }
    });
