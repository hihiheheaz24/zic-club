    ...
    cc.TopupView = cc.Class({
        ...
        historyClicked: function () {
            if (cc.LoginController.getInstance().checkLogin()) {
                cc.LobbyController.getInstance().createTopupTransactionView();
                cc.DDNA.getInstance().uiInteraction(cc.DDNAUILocation.PORTAL, 'CARD_HISTORY', cc.DDNAUIType.BUTTON);
                //this.closeSetting();
            }
        }
    });
