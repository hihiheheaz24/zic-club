...
(function () {
    cc.BottomBarView = cc.Class({
        ...
        onClickVipPoint(){
            if (cc.LoginController.getInstance().checkLogin()) {
                cc.LobbyController.getInstance().createVipPointView();
            }
        },
        ...
        inboxClicked: function () {
            if (cc.LoginController.getInstance().checkLogin()) {
                cc.LobbyController.getInstance().createMailboxView();
                cc.DDNA.getInstance().uiInteraction(cc.DDNAUILocation.PORTAL, 'MAILBOX', cc.DDNAUIType.BUTTON);
            }
        },
