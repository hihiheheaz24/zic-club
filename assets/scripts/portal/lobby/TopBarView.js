...
(function () {
    cc.TopBarView = cc.Class({
        ...
        properties: {
			...
			nodeBtn_MINI_Right: cc.Node,
			//nodeBtn_BannerKM_Right: cc.Node,
        ...
        updateUILogin: function (enable) {
			...
			this.nodeBtn_MINI_Right.active = !enable;
			//this.nodeBtn_BannerKM_Right.active = !enable;
        },

        topBarUpdateInfo: function () {
            console.log("topBarUpdateInfo");
        ...
        topupClicked: function (event,data) {
            console.log(data);
            cc.LobbyController.getInstance().createShopView(data.toString());
            return;
        ...
        showTransfer: function () {
            if (cc.LoginController.getInstance().checkLogin()) {
                cc.LobbyController.getInstance().createTransferView();
            }
        },
