...
(function () {
    cc.TaiXiuPortalView = cc.Class({
        ...
        properties: {
             ...
             lbiTotalHu: cc.LabelIncrement, //tong tien Hu
        },
        ...
        updateJackPot : function (money) {
            this.lbiTotalHu.tweenValueto(money);
        },
            ...
            if (response.M !== undefined && response.M.length > 0) {
                ...
                switch (m.M) {
                    ...
                    case cc.MethodHubOnName.BET_OF_ACCOUNT:
                        ...
                        break;
                    case cc.MethodHubOnName.JACKPOT_UPDATE:
                           var data = m.A[0];
                           console.log('JACKPOT_UPDATE:'+data);
                           this.updateJackPot(data);
                           cc.TaiXiuController.getInstance().updateJackpot(data);
                        break;
                    case cc.MethodHubOnName.JACKPOT_WIN:
                            var data = m.A[0];
                            console.log('JACKPOT_WIN:'+data);
                            //Khoi tao hieu ung khi đang bật TX
                            if (cc.TaiXiuController.getInstance().getIsOpen()) {
                                cc.TaiXiuController.getInstance().showJackpotWin();
                            }
                         break;
                    ...
                    case cc.MethodHubOnName.OTHER_DEVICE:
                        ...
                        cc.PopupController.getInstance().showPopupMessage('Bạn đã đăng nhập trên thiết bị khác');
