...
(function () {
    ...
    TaiXiuController = (function () {
        ...
        TaiXiuController.prototype.showJackpotWin = function (data) {
            if (this.taiXiuResultView)
                return this.taiXiuResultView.SetJackpot(data);
        };
        ...
        TaiXiuController.prototype.updateJackpot = function (data) {
            if (this.taiXiuResultView)
                return this.taiXiuInfoView.updateJackpot(data);
        };
