...
(function () {
    cc.XXInputView = cc.Class({
        ...
        onLoad: function () {
            ...
            this.minXs = [130, 65, 200, -250, -280, -130];
            this.maxXs = [250, 125, 280, -130, -200, -50];
            this.minYs = [45, -90, -90, 45, -90, -90];
            this.maxYs = [63, -73, -73, 63, -73, -73];
        ...
        playerBet: function (info) {
            ...
            if (cc.XXController.getInstance().getPositions()) {
                ...
                if (gate >= this.lbTotalBets.length) return;
        ...
        playFxUserBet: function (playerId, gate, chipIndex, isMove) {
            ...
            if (gate < this.gateChips.length) this.gateChips[gate].push(chipItem);
        },
        ...
        betValueClicked: function (event, data) {
            console.log("chon muc bet clicked:"+data.toString());
