...
(function () {
    cc.XXView = cc.Class({
                    ...
                    switch (m.M) {
                        ...
                        case cc.MethodHubOnName.LIST_LAST_MESSAGES:
                            ...
                            this.chatHistory.forEach(chatItem => {
                                let item = [chatItem.n, chatItem.c, chatItem.s, cc.LoginController.getInstance().getUserId(), false, chatItem.v];
                                cc.ChatRoomController.getInstance().addChatContent(item);
                            });
                            break;
        ...
        backClicked: function () {
            cc.LobbyController.getInstance().destroyDynamicView(null);
            //cc.LobbyController.getInstance().playMusic();
