...
(function () {
    cc.XXSoiCauView = cc.Class({
        ...
        onLoad: function () {
            ...
            this.rootPosX = -210; //toa do goc
            this.rootPosY = -35; //toa do goc
        ...
        newDraw: function (cols) {
            ...
            for (var i = 0; i < cols.length; i++) {
                ...
                switch (cols[i]) {
                    case cc.XXResult.EVEN:
                        item = cc.instantiate(this.nodeEvenTemp);
                        this.even++;
                        break;
                    case cc.XXResult.EVEN_FOUR_DOWN:
                        item = cc.instantiate(this.nodeEvenTemp);
                    ...
                    case cc.XXResult.EVEN_FOUR_UP:
                        ...
                        break;
                    case cc.XXResult.ODD_THREE_DOWN:
                        item = cc.instantiate(this.nodeOddTemp);
                        this.odd++;
                        this.threeDown++;
                        break;
                    case cc.XXResult.ODD_THREE_UP:
                ...
                if(item){
                    item.getComponent(cc.Sprite).spriteFrame = this.sfDots[cols[i]];
