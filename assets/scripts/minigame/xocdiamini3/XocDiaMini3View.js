...
(function () {
    cc.XocDiaMini3View = cc.Class({
        ...
        onLoad: function () {
            cc.XocDiaMini3Controller.getInstance().setXocDiaMini3View(this);
        ...
        onDestroy: function () {
            ...
            cc.XocDiaMini3Controller.getInstance().setXocDiaMini3View(null);

            if (cc.sys.isNative) {
                cc.assetManager.releaseAsset('xocdiamini3/prefabs');
                cc.assetManager.releaseAsset('xocdiamini3/images');
            }
        ...
        updateInfo: function (sessionInfo) {
            ...
            switch (sessionInfo.CurrentState) {
                case cc.XocDiaMini3State.BETTING:

                    break;
                case cc.XocDiaMini3State.OPEN_PLATE:

                    break;
                case cc.XocDiaMini3State.SHOW_RESULT:
        ...
        connectHub: function () {
            ...
            negotiateCommand.execute(this, cc.SubdomainName.XOC_DIA_MINI3);
        },

        reconnect: function () {
            this.lastTimeReconnect = (new Date()).getTime();
            this.xxHub.connect(this, cc.HubName.XocDiaMini3Hub, this.connectionToken, true);
        },
        ...
        onSlotsNegotiateResponse: function (response) {
            ...
            this.xxHub.connect(this, cc.HubName.XocDiaMini3Hub, response.ConnectionToken);
        },
                ...
                mArray.map(m => {
                    switch (m.M) {
                        ...
                        case cc.MethodHubOnName.SESSION_INFO:
                            // cc.XocDiaMini3Controller.getInstance().updateSessionId(m.A[0].SessionID);
                            cc.XocDiaMini3Controller.getInstance().updateInfo(m.A[0], m.A[0].Phrase, null);
                            cc.XocDiaMini3Controller.getInstance().updateInput(m.A[0].Phrase);
                            cc.XocDiaMini3Controller.getInstance().updateResult("update_time", m.A[0]);
                            break;
                        //Lich su choi
                        case cc.MethodHubOnName.GAME_HISTORY:
                            cc.XocDiaMini3Controller.getInstance().resetDraw();
                            //ve bang Soi Cau
                            cc.XocDiaMini3Controller.getInstance().draw(m.A[0]);
                            break;
                        //thoi gian + trang thai phien
                        case cc.MethodHubOnName.START_ACTION_TIMER:
                            var data = m.A;
                            cc.XocDiaMini3Controller.getInstance().updateInfo(data[0], data[2], data[1]);
                            // cc.XocDiaMini3Controller.getInstance().updateResult(data[0].Players, data[0].GameLoop.Result, data[0].GameLoop.OriginResult, data[2]);
                            cc.XocDiaMini3Controller.getInstance().updateResult(null, data[0].Result, data[0].Result.ChipsData, data[2]);
                            cc.XocDiaMini3Controller.getInstance().updateInput(data[2]);
                            break;
                        //nguoi choi roi ban
                        case cc.MethodHubOnName.PLAYER_LEAVE:
                            //phuc vu cho bot Xoc Xoc -> can thoat nhieu ng choi
                            if (mArray.length === 0) {
                                cc.XocDiaMini3Controller.getInstance().playerLeave(m.A);
                            }
                            break;

                        //cap nhat trang thai cua nguoi choi
                        case cc.MethodHubOnName.UPDATE_CONNECTION_STATUS:
                            cc.XocDiaMini3Controller.getInstance().updateConnectionStatus(m.A);
                            break;

                        //cập nhật lại trạng thái player
                        case cc.MethodHubOnName.UPDATE_PLAYER_STATUS:
                            cc.XocDiaMini3Controller.getInstance().updatePlayerStatus(m.A[0]);
                            break;
                        ...
                        case cc.MethodHubOnName.JOIN_GAME:
                            var data = m.A[0];
                            var info = m.A[1];
                            cc.XocDiaMini3Controller.getInstance().updateInfoCurrPlayer(data.Account);
                            cc.PopupController.getInstance().hideBusy();
                            break;
                        //Tai hien cac cua da dat
                        case cc.MethodHubOnName.BET_SESSION:
                            cc.XocDiaMini3Controller.getInstance().showLastInput(m.A[0]);
                            break;
                        ...
                        case cc.MethodHubOnName.PLAYER_BET:
                            var data = m.A;
                            cc.XocDiaMini3Controller.getInstance().playerBet(data);
                            break;
                        ...
                        case cc.MethodHubOnName.WIN_RESULT_VIP:
                            if (m.A.length > 0) {
                                try {
                                    setTimeout(function () {
                                        cc.XocDiaMini3Controller.getInstance().winResultVip(m.A[0]);
                                    }, 2500);
                                } catch (e) {
                        ...
                        case cc.MethodHubOnName.WIN_RESULT:
                            if (m.A.length > 0) {
                                try {
                                    setTimeout(function () {
                                        cc.XocDiaMini3Controller.getInstance().winResult(m.A[0]);
                                    }, 2500);
                                } catch (e) {
                        ...
                        case cc.MethodHubOnName.TOTAL_WIN_MONEY:
                            if(m.A[0] > 0) {
                                setTimeout(function () {
                                    cc.XocDiaMini3Controller.getInstance().totalUserWin(m.A[0]);
                                }, 2500);
                            }
                            break;
                        ...
                        case cc.MethodHubOnName.OPEN_PLATE_NOW:
                            cc.XocDiaMini3Controller.getInstance().updateResult(null, m.A[0], m.A[1], cc.XocDiaMini3State.OPEN_PLATE, true);
                            cc.XocDiaMini3Controller.getInstance().updateInput(cc.XocDiaMini3State.OPEN_PLATE);
                            break;

                        //nhan message chat
                        case cc.MethodHubOnName.RECEIVE_MESSAGE:
                            cc.ChatRoomController.getInstance().addChatContent(m.A);
                            cc.XocDiaMini3Controller.getInstance().playerShowBubbleChat(m.A);
                            break;
                        case cc.MethodHubOnName.SUMMARY_PLAYER:
                            cc.XocDiaMini3Controller.getInstance().summaryPlayer(m.A[0]);
                            break;
                        ...
                        case cc.MethodHubOnName.VIP_PLAYERS:
                            ...
                            if (dataPlayers.length > 0) {
                                cc.XocDiaMini3Controller.getInstance().vipPlayer(dataPlayers);
                            }
                            break;
                        //FIX BUG
                        case 'recieveMessage':
                        ...
                        case cc.MethodHubOnName.UPDATE_ROOM_TIME:
                            cc.XocDiaMini3Controller.getInstance().updateTimer(m.A[0]);
        ...
        helpClicked: function () {
            cc.XocDiaMini3PopupController.getInstance().createHelpView();
        },

        //lich su dat cuoc
        historyClicked: function () {
            cc.XocDiaMini3PopupController.getInstance().createHistoryView();
        },

        //bang xep hang dat cuoc
        topClicked: function () {
            cc.XocDiaMini3PopupController.getInstance().createTopView();
        },

        //bieu do chi tiet cac phien
        graphClicked: function () {
            cc.XocDiaMini3PopupController.getInstance().createGraphView();
        },
		...
		showNodeLon: function () {
			...
			cc.XocDiaMiniController.getInstance().getAnNodeLon();
			cc.XocDiaMini2Controller.getInstance().getAnNodeLon();
			cc.XocDiaMini4Controller.getInstance().getAnNodeLon();
			cc.XocDiaMiniController.getInstance().getSetPositionNodeNho();
			cc.XocDiaMini2Controller.getInstance().getSetPositionNodeNho();
		...
		an3NodeNho:function(){
			if(this.check === false){
				...
				cc.XocDiaMiniController.getInstance().getShowNodeNho();
