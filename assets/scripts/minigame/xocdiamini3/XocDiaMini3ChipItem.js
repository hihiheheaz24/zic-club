...
(function () {
    cc.XocDiaMini3ChipItem = cc.Class({
        ...
        setChip: function (chipIndex) {
            ...
            this.spriteChip.spriteFrame = cc.XocDiaMini3Controller.getInstance().getChips()[chipIndex];
        },
        ...
        moveToEndFinished: function (node) {
            ...
            try {
                setTimeout(function () {
                    cc.XocDiaMini3Controller.getInstance().putToPool(node);
                }.bind(this), 500);
            } catch (e) {
            }
