    ...
    cc.XocDiaMini3Player = cc.Class({
        ...
        playerResultUI: function (isWin, amount) {
            ...
            if (isWin) {
                ...
                this.lbWin.font = cc.XocDiaMini3Controller.getInstance().getWinFont();
            } else {
                this.nodeLose.active = true;
                this.lbWin.string = cc.Tool.getInstance().formatNumber(amount);
                this.lbWin.font = cc.XocDiaMini3Controller.getInstance().getLoseFont();
            }
