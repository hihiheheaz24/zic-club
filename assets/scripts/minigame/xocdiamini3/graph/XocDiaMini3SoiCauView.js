...
(function () {
    cc.XocDiaMini3SoiCauView = cc.Class({
        ...
        onLoad: function () {
            cc.XocDiaMini3Controller.getInstance().setXocDiaMini3SoiCauView(this);
        ...
        getSide: function (gate) {
            ...
            switch (gate) {
                case cc.XocDiaMini3Result.EVEN:
                    return 'EVEN';
                case cc.XocDiaMini3Result.EVEN_FOUR_DOWN:
                    return 'EVEN';
                case cc.XocDiaMini3Result.EVEN_FOUR_UP:
                    return 'EVEN';
                case cc.XocDiaMini3Result.ODD_THREE_DOWN:
                    return 'ODD';
                case cc.XocDiaMini3Result.ODD_THREE_UP:
                    return 'ODD';
                case cc.XocDiaMini3Result.TWO:
                    return 'TWO';
            }
        },
        ...
        createNode: function (item, pos) {
            ...
            //     this.gameAssets = cc.XocDiaMini3Controller.getInstance().getAssets();
            // }
