...
(function () {
    cc.XocDiaMini3ResultView = cc.Class({
        ...
        onLoad: function () {
            cc.XocDiaMini3Controller.getInstance().setXocDiaMini3ResultView(this);
        ...
        updateResult: function (players, result, originResult, state, openNow) {
            if (players == "update_time" && result["Phrase"] == cc.XocDiaMini3State.BETTING) {
                if (result["Elapsed"] < 5) {
                    [
                        this.nodeChan1,
                        this.nodeChan2,
            ...
            switch (state) {
                ...
                case cc.XocDiaMini3State.WAITING:
                    if (this.currentState !== state) {
                        cc.XocDiaMini3Controller.getInstance().initGateChip();
        ...
        playFxResult: function (result, originResult, openNow) {
            ...
            //dang o che do Nan
            if (cc.XocDiaMini3Controller.getInstance().getIsNan() && !openNow) {
                //bat bat Nan
                this.nodeDia.active = true;
        ...
        playPayFx: function (players, result) {
            ...
            let gateChips = cc.XocDiaMini3Controller.getInstance().getGateChips();
            var self = this;
            ...
            this.fxMoveChip(arrGateLose, cc.XocDiaMini3_FX.LOSE);
            ...
            setTimeout(function () {
                this.fxMoveChip(arrGateWin, cc.XocDiaMini3_FX.DEALER_PAY);
            }.bind(this), 1000);
            ...
            setTimeout(function () {
                this.fxMoveChip(arrGateWin, cc.XocDiaMini3_FX.PAY);
            }.bind(this), 2000); */
                ...
                arrGate.map(gateIndex => {
                    if (gateChips[gateIndex] && gateChips[gateIndex].length) {
                        gateChips[gateIndex].forEach(function (chip) {
                            switch (typeFx) {
                                case cc.XocDiaMini3_FX.LOSE:
                                    cc.XocDiaMini3Controller.getInstance().playFxLost(chip);
                                    break;
                                case cc.XocDiaMini3_FX.DEALER_PAY:
                                    cc.XocDiaMini3Controller.getInstance().playFxDealerPay(chip);
                                    break;
                                case cc.XocDiaMini3_FX.PAY:
                                    cc.XocDiaMini3Controller.getInstance().playFxPay(chip);
                                    break;
                            }
                        })
                    }
