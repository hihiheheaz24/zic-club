    ...
    cc.XocDiaVipPlayer = cc.Class({
        ...
        playerResultUI: function (isWin, amount) {
            ...
            if (isWin) {
                ...
                this.lbWin.font = cc.XocDiaVipController.getInstance().getWinFont();
            } else {
                this.nodeLose.active = true;
                this.lbWin.string = cc.Tool.getInstance().formatNumber(amount);
                this.lbWin.font = cc.XocDiaVipController.getInstance().getLoseFont();
            }
        ...
        updateChip: function (chip) {
            this.lbChip.tweenValueto((parseInt(chip)));
        },
        ...
        registerPlayer: function (accountInfo) {
            ...
            //set chip
            this.lbChip.tweenValueto((parseInt(accountInfo.Balance)));
