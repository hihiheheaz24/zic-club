...
(function () {
    cc.XocDiaVipChipItem = cc.Class({
        ...
        setChip: function (chipIndex) {
            ...
            this.spriteChip.spriteFrame = cc.XocDiaVipController.getInstance().getChips()[chipIndex];
        },
        ...
        moveToEndFinished: function (node) {
            ...
            try {
                setTimeout(function () {
                    cc.XocDiaVipController.getInstance().putToPool(node);
                }.bind(this), 500);
            } catch (e) {
            }
