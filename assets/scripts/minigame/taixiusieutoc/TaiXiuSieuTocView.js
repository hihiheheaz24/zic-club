...
(function () {
    cc.TaiXiuSieuTocView = cc.Class({
        ...
        onLoad: function () {
            ...
            if (cc.TaiXiuSieuTocController.getInstance().connectHubTxSieuTocAuthorize()) {
        ...
        onDestroy: function () {
            ...
            if (cc.sys.isNative) {
                cc.assetManager.releaseAsset('taixiusieutoc/prefabs');
                cc.assetManager.releaseAsset('taixiusieutoc/images');
            }
        ...
        closeClicked: function () {
            ...
            cc.director.getScheduler().schedule(function () {
                self.animation.stop();
                cc.LobbyController.getInstance().destroyDynamicView(cc.GameId.TAI_XIU_SIEUTOC);
