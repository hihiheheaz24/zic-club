    ...
    cc.BauCuaInfoView = cc.Class({
        ...
        forceOpenPlate: function (isAuto) {
            ...
            if ((!isNan && isAuto) || (!isAuto && isNan)) {
                if(this.currentState != cc.BauCuaAnim.OPEN_PLATE){
        ...
        playAnimBat: function (nameAnim) {
            ...
            this.skeletonBat.setAnimation(0, nameAnim, false);
        },
        ...
        onNotifyChangePhrase: function (data) {
            ...
            switch (state) {
                ...
                case cc.BauCuaPharse.Shaking://Xoc
                    if (this.currentState !== state) {
                        this.updatePlayersUI(window.baucuaVipPlayers);
                        this.playAnimBat(cc.BauCuaAnim.SHAKING);
                        this.playAudio(this.xocxocSound);
                        this.controller.enableClickBet(false);
                    }
                    break;
        ...
        playAudio: function (audioPlay) {
            if (audioPlay) cc.audioEngine.play(audioPlay, false, 1);
        }
    });
}).call(this);