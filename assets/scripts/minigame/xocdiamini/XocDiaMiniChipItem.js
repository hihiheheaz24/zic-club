...
(function () {
    cc.XocDiaMiniChipItem = cc.Class({
        ...
        setChip: function (chipIndex) {
            ...
            this.spriteChip.spriteFrame = cc.XocDiaMiniController.getInstance().getChips()[chipIndex];
        },
        ...
        moveToEndFinished: function (node) {
            ...
            try {
                setTimeout(function () {
                    cc.XocDiaMiniController.getInstance().putToPool(node);
                }.bind(this), 500);
            } catch (e) {
            }
