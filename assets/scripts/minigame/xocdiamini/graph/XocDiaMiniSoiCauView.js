...
(function () {
    cc.XocDiaMiniSoiCauView = cc.Class({
        ...
        onLoad: function () {
            cc.XocDiaMiniController.getInstance().setXocDiaMiniSoiCauView(this);
        ...
        getSide: function (gate) {
            ...
            switch (gate) {
                case cc.XocDiaMiniResult.EVEN:
                    return 'EVEN';
                case cc.XocDiaMiniResult.EVEN_FOUR_DOWN:
                    return 'EVEN';
                case cc.XocDiaMiniResult.EVEN_FOUR_UP:
                    return 'EVEN';
                case cc.XocDiaMiniResult.ODD_THREE_DOWN:
                    return 'ODD';
                case cc.XocDiaMiniResult.ODD_THREE_UP:
                    return 'ODD';
                case cc.XocDiaMiniResult.TWO:
                    return 'TWO';
            }
        },
        ...
        createNode: function (item, pos) {
            ...
            //     this.gameAssets = cc.XocDiaMiniController.getInstance().getAssets();
            // }
