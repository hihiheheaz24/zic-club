    ...
    cc.XocDiaMiniPlayer = cc.Class({
        ...
        playerResultUI: function (isWin, amount) {
            ...
            if (isWin) {
                ...
                this.lbWin.font = cc.XocDiaMiniController.getInstance().getWinFont();
            } else {
                this.nodeLose.active = true;
                this.lbWin.string = cc.Tool.getInstance().formatNumber(amount);
                this.lbWin.font = cc.XocDiaMiniController.getInstance().getLoseFont();
            }
