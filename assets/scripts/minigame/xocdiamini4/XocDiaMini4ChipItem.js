...
(function () {
    cc.XocDiaMini4ChipItem = cc.Class({
        ...
        setChip: function (chipIndex) {
            ...
            this.spriteChip.spriteFrame = cc.XocDiaMini4Controller.getInstance().getChips()[chipIndex];
        },
        ...
        moveToEndFinished: function (node) {
            ...
            try {
                setTimeout(function () {
                    cc.XocDiaMini4Controller.getInstance().putToPool(node);
                }.bind(this), 500);
            } catch (e) {
            }
