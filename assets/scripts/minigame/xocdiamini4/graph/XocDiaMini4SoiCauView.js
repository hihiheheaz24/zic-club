...
(function () {
    cc.XocDiaMini4SoiCauView = cc.Class({
        ...
        onLoad: function () {
            cc.XocDiaMini4Controller.getInstance().setXocDiaMini4SoiCauView(this);
        ...
        getSide: function (gate) {
            ...
            switch (gate) {
                case cc.XocDiaMini4Result.EVEN:
                    return 'EVEN';
                case cc.XocDiaMini4Result.EVEN_FOUR_DOWN:
                    return 'EVEN';
                case cc.XocDiaMini4Result.EVEN_FOUR_UP:
                    return 'EVEN';
                case cc.XocDiaMini4Result.ODD_THREE_DOWN:
                    return 'ODD';
                case cc.XocDiaMini4Result.ODD_THREE_UP:
                    return 'ODD';
                case cc.XocDiaMini4Result.TWO:
                    return 'TWO';
            }
        },
        ...
        createNode: function (item, pos) {
            ...
            //     this.gameAssets = cc.XocDiaMini4Controller.getInstance().getAssets();
            // }
