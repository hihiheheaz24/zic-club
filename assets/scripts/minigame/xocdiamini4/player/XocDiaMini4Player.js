    ...
    cc.XocDiaMini4Player = cc.Class({
        ...
        playerResultUI: function (isWin, amount) {
            ...
            if (isWin) {
                ...
                this.lbWin.font = cc.XocDiaMini4Controller.getInstance().getWinFont();
            } else {
                this.nodeLose.active = true;
                this.lbWin.string = cc.Tool.getInstance().formatNumber(amount);
                this.lbWin.font = cc.XocDiaMini4Controller.getInstance().getLoseFont();
            }
