...
(function () {
    cc.XocDiaMini2InfoView = cc.Class({
        ...
        properties: {
            ...
            //players
            xxPlayers: [cc.XocDiaMini2Player],
        ...
        onLoad: function () {
            ...
            this.timeBet = 54;
            this.reset();
            cc.XocDiaMini2Controller.getInstance().setXocDiaMini2InfoView(this);
        ...
        joinGame: function (info) {
            ...
            cc.XocDiaMini2Controller.getInstance().updatePositionPlayerUI(this.positionsUI);
        },
        ...
        updateConnectionStatus: function (info) {
            if (this.positionsUI) {
                ...
                if (status === cc.XocDiaMini2ConnectionStatus.REGISTER_LEAVE_GAME && accID === cc.LoginController.getInstance().getUserId()) {
        ...
        totalUserWin: function (amount) {
            ...
            this.lbTotalUserWin.font = cc.XocDiaMini2Controller.getInstance().getWinFont();
            //play fx thang
                ...
                this.xxPlayers.forEach(function (xxPlayer) {
                    if (xxPlayer.nickName === message[0]) {
                        xxPlayer.showEmotion(cc.ChatRoomController.getInstance().getIndexEmotion(message)
                            // >>>>>>> remotes/origin/Update-DgTiger-XocDiaMini2
                            , message);
                    }
                });
            } else {
        ...
        updateTimer: function (time) {
            if (this.lbTimer) {
                ...
                if (timeInt > 0) {
                    ...
                    if (timeInt <= 5 && this.currentState === cc.XocDiaMini2State.BETTING) {
                    ...
                    if (this.currentState === cc.XocDiaMini2State.SHOW_RESULT) {
            ...
            switch (state) {
                ...
                case cc.XocDiaMini2State.BETTING: //54
                    if (this.currentState !== state) {
                        ...
                        cc.XocDiaMini2Controller.getInstance().setSID(info.SessionID);
                        ...
                        //cc.XocDiaMini2Controller.getInstance().draw(info.History.reverse());
                    }
                    break;
                ...
                case cc.XocDiaMini2State.SHAKING:
                    if (this.currentState !== state) {
                        this.updateSessionId(info.SessionID);
                        cc.XocDiaMini2Controller.getInstance().clearAllChip();
                        this.progressTimer.node.parent.active = false;
                        // this.startTimer(time);
                        this.resetPlayersResultUI();
                        this.lbTimer.node.color = cc.Color.WHITE;
