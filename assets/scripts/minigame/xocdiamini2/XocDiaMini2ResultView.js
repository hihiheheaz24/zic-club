...
(function () {
    cc.XocDiaMini2ResultView = cc.Class({
        ...
        onLoad: function () {
            cc.XocDiaMini2Controller.getInstance().setXocDiaMini2ResultView(this);
        ...
        updateResult: function (players, result, originResult, state, openNow) {
            if (players == "update_time" && result["Phrase"] == cc.XocDiaMini2State.BETTING) {
                if (result["Elapsed"] < 5) {
                    [
                        this.nodeChan1,
                        this.nodeChan2,
            ...
            switch (state) {
                ...
                case cc.XocDiaMini2State.WAITING:
                    if (this.currentState !== state) {
                        cc.XocDiaMini2Controller.getInstance().initGateChip();
        ...
        playFxResult: function (result, originResult, openNow) {
            ...
            //dang o che do Nan
            if (cc.XocDiaMini2Controller.getInstance().getIsNan() && !openNow) {
                //bat bat Nan
                this.nodeDia.active = true;
        ...
        playPayFx: function (players, result) {
            ...
            let gateChips = cc.XocDiaMini2Controller.getInstance().getGateChips();
            var self = this;
            ...
            this.fxMoveChip(arrGateLose, cc.XocDiaMini2_FX.LOSE);
            ...
            setTimeout(function () {
                this.fxMoveChip(arrGateWin, cc.XocDiaMini2_FX.DEALER_PAY);
            }.bind(this), 1000);
            ...
            setTimeout(function () {
                this.fxMoveChip(arrGateWin, cc.XocDiaMini2_FX.PAY);
            }.bind(this), 2000); */
                ...
                arrGate.map(gateIndex => {
                    if (gateChips[gateIndex] && gateChips[gateIndex].length) {
                        gateChips[gateIndex].forEach(function (chip) {
                            switch (typeFx) {
                                case cc.XocDiaMini2_FX.LOSE:
                                    cc.XocDiaMini2Controller.getInstance().playFxLost(chip);
                                    break;
                                case cc.XocDiaMini2_FX.DEALER_PAY:
                                    cc.XocDiaMini2Controller.getInstance().playFxDealerPay(chip);
                                    break;
                                case cc.XocDiaMini2_FX.PAY:
                                    cc.XocDiaMini2Controller.getInstance().playFxPay(chip);
                                    break;
                            }
                        })
                    }
