...
(function () {
    cc.XocDiaMini2ChipItem = cc.Class({
        ...
        setChip: function (chipIndex) {
            ...
            this.spriteChip.spriteFrame = cc.XocDiaMini2Controller.getInstance().getChips()[chipIndex];
        },
        ...
        moveToEndFinished: function (node) {
            ...
            try {
                setTimeout(function () {
                    cc.XocDiaMini2Controller.getInstance().putToPool(node);
                }.bind(this), 500);
            } catch (e) {
            }
