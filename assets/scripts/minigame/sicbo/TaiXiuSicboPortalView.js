    ...
    cc.TaiXiuSicboPortalView = cc.Class({
        ...
        onLoad: function () {
            ...
            try {
                ...
                console.log("Error connecting connectHubTxSicbo");
                cc.PopupController.getInstance().hideBusy();
                cc.PopupController.getInstance().showMessage('Có lỗi kết nối đến Server hoặc game đang bảo trì');
            }
        ...
        updateInfo: function (sicbosessionInfo) {
			...
			cc.MINIController.getInstance().updateInfoTx(sicbosessionInfo, this.currentState);
        ...
        reconnect: function () {
            ...
            this.lastTimeReconnect = (new Date()).getTime();
            this.SicboluckyDiceHub.connect(this, cc.HubName.SicboLuckyDiceHub, this.connectionToken, true);
            timeAll = 60;
        },
        ...
        onLuckyDiceNegotiateResponse: function (response) {
            ...
            this.SicboluckyDiceHub.connect(this, cc.HubName.SicboLuckyDiceHub, response.ConnectionToken);
        },
            ...
            if (response.M !== undefined && response.M.length > 0) {
                ...
                switch (m.M) {
                    ...
                    case cc.MethodHubOnName.GAME_HISTORY_SICBO:
                        ...
                        //login roi -> moi goi
                        if (cc.LoginController.getInstance().getLoginState() && cc.TaiXiuSicboController.getInstance().getIsOpen()) {
                    ...
                    case cc.MethodHubOnName.BET_OF_ACCOUNT_SICBO:
                        cc.director.getScheduler().schedule(function () {
                            cc.TaiXiuSicboController.getInstance().updateBetInfoView(m.A[0]);
                        }, this, 1, 0, 0.2, false);
                        break;
                    ...
                    case cc.MethodHubOnName.CORD_ACCOUNT_INFO_SICBO:
                        ...
                        if (data.IsEventDragon) {
                            ...
                            cc.TaiXiuSicboController.getInstance().setUserCord(data.CordWin, data.CordLost);
                        } else {
                    ...
                    case cc.MethodHubOnName.EVENT_WINNER_RESULT_SICBO:
                        ...
                        if (cc.LobbyController.getInstance().checkLobbyActive() || cc.TaiXiuSicboController.getInstance().getIsOpen()) {
                    ...
                    case cc.MethodHubOnName.BET_SUCCESS_SICBO:
                        ...
                        cc.DDNA.getInstance().betSummary(cc.DDNAGame.TAI_XIU_SICBO, data.BetValue, cc.TaiXiuSicboController.getInstance().getSID());
                        break;
                    case cc.MethodHubOnName.WIN_RESULT_SICBO:
                        ...
                        cc.director.getScheduler().schedule(function () {
                            //play fx win
                            cc.TaiXiuSicboController.getInstance().playEffectWin(data.Award);
                            //update lai balance
                    ...
                    case cc.MethodHubOnName.OTHER_DEVICE:
                        ...
                        cc.PopupController.getInstance().showPopupOtherDevice( m.A[1], cc.GameId.TAI_XIU_SICBO);
                        break;
                }
            }  else {
                //PING PONG
