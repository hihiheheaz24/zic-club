...
(function () {
    cc.TaiXiuSicboSessionDetailView = cc.Class({
        ...
        getSessionDetail: function () {
            ...
            this.sicbogameHistory = cc.TaiXiuSicboController.getInstance().getGameHistory();
        ...
        getSessionDetailById: function (index) {
            ...
            var txsicboGetSessionInfoCommand = new cc.TXSICBOGetSessionInfoCommand;
            txsicboGetSessionInfoCommand.execute(this, game.SessionId);
			
            var txsicboGetResultSessionInfoCommand = new cc.TXSICBOGetResultSessionInfoCommand;
