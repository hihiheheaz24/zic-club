...
(function () {
    ...
    cc.PopupView = cc.Class({
        ...
        properties: {
            ...
            //popup co button
            nodePopupMessage: cc.Node,
            lbContentMessage: cc.Label,
        ...
        init: function () {
            ...
            this.animationPopupM = this.nodePopupMessage.getComponent(cc.Animation);
        ...
        showPopupMessage: function (content) {
            if (this.nodePopupMessage.active) return;
            this.lbContentMessage.string = content;
            this.nodePopupMessage.active = true;
            this.animationPopupM.play('openPopup');
        },

        hidePopupMessage: function () {
            if (!this.nodePopupMessage.active) return;
            this.lbContentMessage.string = "";           
            this.animationPopupM.play('closePopup');
            this.nodePopupMessage.active = false;
        },
        ...
        showPopupSimple: function (content, titleButton, clickEventHandler) {
            ...
            try {
                ...
                cc.log("Check loi show popup :" , error)
            }
